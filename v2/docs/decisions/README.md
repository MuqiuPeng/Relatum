...
- [0074](0074-phase-emergence-1-shape-co-occurrence-mining.md) — Phase Emergence-1: shape co-occurrence mining (concept lifting). Mints second-order concepts from co-occurring shape-families across Signal-class theories; validates via cross-precision; registers as meta-R. Proposed; ships in next commit.
