...
fn main() {
    ...
    // ====================================================
    let mut rs = build_mixed_graph();
    let tighter = NamingPolicy { min_edges: 2, min_instances: 2, skip_meta_subgraphs: true };
    ...
    // ====================================================
    let mut rs = build_mixed_graph();
    let permissive = NamingPolicy { min_edges: 1, min_instances: 1, skip_meta_subgraphs: true };
