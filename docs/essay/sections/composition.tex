...
\subsection{Property Space Analysis}

The combination scoring infrastructure enables a structural characterization of each domain's property space. For every pair of properties, the degenerate diagnosis carries implicit information:
